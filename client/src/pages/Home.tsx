    ...
    return (
        <div className="min-h-screen bg-gray-50 text-gray-800 font-sans">
            ...
            <header className="bg-white border-b border-gray-200">
                <div className="container mx-auto px-4 h-16 flex items-center justify-between">
                    <div className="flex items-center space-x-8">
                        <Link href="/" className="text-2xl font-bold text-[#0076C0] tracking-tighter cursor-pointer">
                            Online Judge
                        </Link>
                        <nav className="hidden md:flex space-x-6 text-sm font-medium text-gray-600">
                            <a href="/problems" className="hover:text-[#0076C0]">문제</a>
                    ...
                    <div className="flex items-center space-x-4">
                        <div className="relative hidden md:block">
                            <Input
                                type="text"
                                placeholder="문제 검색"
                                className="w-64 h-8 text-sm bg-gray-100 border-none focus:ring-1 focus:ring-[#0076C0] pr-8"
                            />
                            <Search className="absolute right-2 top-2 h-4 w-4 text-gray-400" />
                        </div>
                        <div className="flex items-center space-x-3 text-sm">
                            <Link href="/login" className="text-gray-500 hover:text-[#0076C0] cursor-pointer">로그인</Link>
                            <span className="text-gray-300">|</span>
                            <Link href="/register" className="text-gray-500 hover:text-[#0076C0] cursor-pointer">가입</Link>
                        </div>
                    </div>
                </div>
            </header>
            ...
            <main className="container mx-auto px-4 py-8">
                {/* Search Hero Section (Added as requested) */}
                <div className="mb-8 bg-white p-8 rounded-sm shadow-sm border border-gray-200 text-center">
                    <h1 className="text-2xl font-bold text-gray-800 mb-4">무엇을 풀고 싶으신가요?</h1>
                    <div className="max-w-2xl mx-auto relative">
                        <Input 
                            type="text" 
                            placeholder="문제 번호, 제목, 알고리즘 분류로 검색해보세요" 
                            className="w-full h-12 text-lg pl-4 pr-12 border-2 border-[#0076C0] focus:ring-2 focus:ring-[#0076C0] focus:border-transparent rounded-md"
                        />
                        <Button className="absolute right-1 top-1 h-10 w-10 p-0 bg-[#0076C0] hover:bg-[#005a9e] rounded-md">
                    ...
                    <div className="lg:col-span-3 space-y-6">
                        ...
                        <div className="bg-white p-6 rounded-sm shadow-sm border border-gray-200">
                            <div className="flex justify-between items-center mb-4 border-b pb-2">
                                ...
                                <Link href="/problems" className="text-xs text-[#0076C0] hover:underline cursor-pointer">더보기</Link>
                            </div>
                                        ...
                                        {[1000, 1001, 1002, 1003, 1004].map((id) => (
                                            <tr key={id} className="hover:bg-gray-50 transition-colors">
                                                ...
                                                <td className="px-4 py-2 font-medium text-gray-800">
                                                    <Link href={`/solve/${id}`} className="hover:underline hover:text-[#0076C0] cursor-pointer">
                                                        A+B
                                                    </Link>
                                                </td>
